...
class Grub2(object):
    ...
    def modify_grub_default(self):
        ...
        self.set_grub_option(
            "GRUB_THEME", "/boot/grub/themes/Reborn-Default/theme.txt")
    ...
    def install_efi(self):
        ...
        fpath = '/install/boot/efi/EFI/reborn_grub'
        bootloader_id = 'reborn_grub' if not os.path.exists(fpath) else \
            'reborn_grub_{0}'.format(random_generator())
